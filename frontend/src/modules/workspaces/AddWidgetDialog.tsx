 ...
 * 위젯 추가 — **홈에서 출발하는 길.**
 *
 * 위젯을 올리는 자리는 목록 화면의 「묶어 보기」 다. 그런데 「여기 뭘 좀 띄우고 싶다」
 * 는 생각은 **홈을 보다가** 나고, 그때 사람은 어느 타입의 목록으로 가야 하는지부터
 * 막힌다. 여기서 타입만 고르면 그 목록이 묶어 보기를 펼친 채로 열린다.
 *
    ...
    <Dialog open onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            무엇을 띄울지 고르면 그 목록이 <strong>묶어 보기를 펼친 채로</strong> 열립니다. 거기서
            조건과 축을 정하고 「홈에 올리기」 를 누르면 여기 섭니다.
          </DialogDescription>
        </DialogHeader>
